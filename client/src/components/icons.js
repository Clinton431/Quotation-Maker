...
//
// Every icon is a tiny React component that spreads all props onto the <svg>
// so className, style, onClick, aria-* etc. all work out of the box.
...
export const Icon = {
  ...
  // ── Settings tab (same as Gear, kept for TABS array reference) ─────────────
  Settings: (p) => (
    <svg
      {...p}
      viewBox="0 0 24 24"
